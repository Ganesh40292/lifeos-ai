...
/**
 * Returns whether the referenced element is currently worth animating.
 */
...
@media (forced-colors: active) {
  ...
  return (
    <div
      ...
      onBlur={settle}
      className={cn(
        "relative w-full border border-border bg-bg-card/85 backdrop-blur-xl p-10 shadow-2xl transition-[border-color,box-shadow] duration-300 cursor-default",
        cls,
        className
      )}
      style={{
