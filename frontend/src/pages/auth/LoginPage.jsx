...
import { Mail, Lock, Zap, Eye, EyeOff, ShieldCheck, ArrowRight } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative z-10">
        ...
        >
          <BorderBeamPanel
            ...
            className="w-full space-y-7 rounded-[20px] border border-border hover:border-primary/40 bg-bg-card/85 backdrop-blur-xl shadow-2xl hover:shadow-primary/10 hover:shadow-3xl transition-[border-color,box-shadow] duration-300 cursor-default"
          >
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-xs font-semibold text-text-muted uppercase tracking-wider">Sign In</span>
            </div>
          ...
          {twoFactorPending ? (
            <form onSubmit={handle2FaSubmit} className="space-y-4">
              <div className="text-left">
                ...
                <p className="text-xs text-text-muted mt-1">Enter your 6-digit authenticator code</p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <p className="text-xs text-text-muted mt-1">Sign in to your {APP_NAME} workspace</p>
              </div>
              ...
              <button
                ...
                onClick={() => {
                  setLoading(true);
                  setTimeout(() => {
                    // Perform quick single sign-on authentication
